...
declare -A MSG_ZH=(
    ...
    ["opt_version"]="指定要安装的版本号 (例如: v0.1.169-qiu.5)"
...
declare -A MSG_EN=(
    ...
    ["opt_version"]="Specify version to install (e.g., v0.1.169-qiu.5)"
...
main() {
    ...
    case "${1:-}" in
        ...
        --help|-h)
            ...
            echo "  $0 install -v v0.1.169-qiu.5 # Install specific version"
            echo "  $0 upgrade                # Upgrade to latest"
            echo "  $0 upgrade -v v0.1.169-qiu.5 # Upgrade to specific version"
