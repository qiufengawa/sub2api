...
# Sub2API 安装脚本
# Usage: curl -sSL https://raw.githubusercontent.com/qiufengawa/sub2api/ui/main/deploy/install.sh | bash
#
...
# Configuration
GITHUB_REPO="qiufengawa/sub2api"
...
declare -A MSG_ZH=(
    ...
    ["opt_version"]="指定要安装的版本号 (例如: v0.1.169-qiu.3.1)"
...
declare -A MSG_EN=(
    ...
    ["opt_version"]="Specify version to install (e.g., v0.1.169-qiu.3.1)"
...
Documentation=https://github.com/qiufengawa/sub2api
...
main() {
    ...
    case "${1:-}" in
        ...
        --help|-h)
            ...
            echo "  $0 install -v v0.1.169-qiu.3.1 # Install specific version"
            echo "  $0 upgrade                # Upgrade to latest"
            echo "  $0 upgrade -v v0.1.169-qiu.3.1 # Upgrade to specific version"
