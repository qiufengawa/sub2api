...
curl -sSL https://raw.githubusercontent.com/qiufengawa/sub2api/ui/main/deploy/docker-deploy.sh -o docker-deploy.sh
...
1. Download the latest release from [GitHub Releases](https://github.com/qiufengawa/sub2api/releases)
