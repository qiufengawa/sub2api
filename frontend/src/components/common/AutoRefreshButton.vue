<template>
  <div class="relative" ref="dropdownRef">
    <button
      ...
      class="inline-flex min-h-7 items-center gap-1.5 rounded-[3px] border border-gray-200 bg-white px-2.5 py-1 text-xs font-medium text-gray-700 transition-colors hover:bg-gray-50 dark:border-dark-600 dark:bg-dark-800 dark:text-gray-300 dark:hover:bg-dark-700"
    ...
    <div
      v-if="showDropdown"
      class="absolute right-0 z-20 mt-1 w-44 rounded-[4px] border border-gray-200 bg-white shadow-md dark:border-dark-600 dark:bg-dark-800"
    >
      <div class="p-1.5">
        <button
