...
describe('AccountUsageCell', () => {
  ...
  it('Key 账号会展示 today stats 徽章并带 A/U 提示', async () => {
	  ...
	  expect(wrapper.text()).toContain('admin.accounts.usageWindow.requests1.0M')
	  expect(wrapper.text()).toContain('admin.accounts.usageWindow.tokens1.0B')
	  expect(wrapper.text()).toContain('admin.accounts.usageWindow.accountCost$12.35')
	  expect(wrapper.text()).toContain('admin.accounts.usageWindow.userCost$6.79')
  ...
  it('Vertex 账号会在 Gemini 用量窗口里展示 today stats 徽章', async () => {
	  ...
	  expect(wrapper.text()).toContain('admin.accounts.usageWindow.requests0')
	  expect(wrapper.text()).toContain('admin.accounts.usageWindow.tokens0')
	  expect(wrapper.text()).toContain('admin.accounts.usageWindow.accountCost$0.00')
	  expect(wrapper.text()).toContain('admin.accounts.usageWindow.userCost$0.00')
  })
