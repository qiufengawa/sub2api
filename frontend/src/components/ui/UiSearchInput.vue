...
border:0;
color:inherit;
background:transparent}.ui-search--mini input{height:var(--ui-control-mini)}.ui-search--dense input{height:var(--ui-control-dense)}.ui-search--compact input,.ui-search--default input{height:var(--ui-control-default)}.ui-search--large input{height:var(--ui-control-large)}</style>
