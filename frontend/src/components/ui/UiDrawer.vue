...
const { panelRef } = useOverlayLifecycle(toRef(props, 'show'), () => emit('close'))
</script>
...
padding:16px;
overflow:auto}.ui-drawer-enter-active,.ui-drawer-leave-active{transition:opacity var(--ui-motion-base)}.ui-drawer-enter-active .ui-drawer,.ui-drawer-leave-active .ui-drawer{transition:transform var(--ui-motion-base)}.ui-drawer-enter-from,.ui-drawer-leave-to{opacity:0}.ui-drawer-enter-from .ui-drawer--right,.ui-drawer-leave-to .ui-drawer--right{transform:translateX(100%)}.ui-drawer-enter-from .ui-drawer--left,.ui-drawer-leave-to .ui-drawer--left{transform:translateX(-100%)}</style>
