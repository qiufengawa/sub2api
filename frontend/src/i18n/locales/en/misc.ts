      ...
      paymentConfigDesc: 'Configure payment providers and settings',
	      ...
	      catalogImport: {
	        ...
	        fields: {
	          ...
	          notes: 'Notes', missing_accounts: 'Accounts to add', included_group_keys: 'Included groups', cycle_quota_usd: 'Credits per cycle', total_quota_usd: 'Term total credits', reset_interval_seconds: 'Reset interval', value: 'Value',
	        },
	        issueCodes: {
