export default {
  ...
  payment: {
    ...
    result: {
      ...
      subscriptionCompletedHint: 'Payment confirmed. Your subscription benefits are now active.',
    ...
    admin: {
      ...
      paymentConfigDesc: 'Configure payment providers and settings',
	      ...
	      catalogImport: {
	        ...
	        templateSuccess: 'Added {count} available account-source groups and {routes} required model routes to the template',
	        templatePartial: 'Added {count} account sources and {routes} model routes; {failed} sources could not be inspected and {omitted} items were skipped due to safety limits or unsupported wildcard patterns. Review the import preview carefully.',
	        templateNoSources: 'No active group with accounts was found. The template was downloaded; bind accounts after import.',
	        ...
	        securityNotice: 'Only catalog configuration is processed. Payment credentials, upstream tokens, users, API keys, orders, usage, and historical subscriptions are never imported. Downloaded templates automatically include available account-source groups from this installation.',
	        ...
	        fields: {
	          ...
	          notes: 'Notes', missing_accounts: 'Accounts to add', value: 'Value',
	        },
	        issueCodes: {
