  ...
  payment: {
    ...
    admin: {
      ...
      offSale: 'Off Sale',
	      ...
	      includedGroups: 'Included routing groups',
	      includedGroupsHint: 'Users can bind API keys to these groups. Each request uses the selected group\'s own rate. The primary group is retained for legacy compatibility and is always included.',
      ...
      paymentConfigDesc: 'Configure payment providers and settings',
	      ...
	      catalogImport: {
	        ...
	        issueCodes: {
	          ...
	          PLAN_GROUP_REQUIRED: 'A plan must identify its primary group with group_key or group_id.', PLAN_GROUP_REFERENCE_AMBIGUOUS: 'A plan cannot set both group_key and group_id.',
	          PLAN_GROUP_ID_INVALID: 'A plan primary group ID must be a positive integer.', PLAN_INCLUDED_GROUP_ID_INVALID: 'Included group IDs must be positive integers.',
