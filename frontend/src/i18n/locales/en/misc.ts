export default {
  ...
  userSubscriptions: {
    ...
    remainingTime: 'Time remaining',
	    ...
	    pendingSettlement: '{amount} credits pending settlement',
  ...
  payment: {
    ...
    admin: {
      ...
      offSale: 'Off Sale',
	      ...
	      cycleQuotaHint: 'One credit represents USD 1 of in-app usage. Leave empty to retain legacy group limits.',
	      cycleQuotaRequired: 'Cycle credits must be greater than zero',
	      totalQuota: 'Term total credits',
	      ...
	      totalQuotaRequired: 'Term total credits must be greater than zero',
