export default {
  ...
  payment: {
    ...
    result: {
      ...
      subscriptionCompletedHint: 'Your subscription is active. Open My Subscriptions to create a new key or bind an existing key to the subscription group before using it.',
      ...
      paymentConfigDesc: 'Configure payment providers and settings',
	      ...
	      catalogImport: {
	        ...
	        issueCodes: {
	          ...
	          PLATFORM_INVALID: 'The platform is unsupported.', SUBSCRIPTION_TYPE_INVALID: 'Catalog groups must use subscription billing.',
