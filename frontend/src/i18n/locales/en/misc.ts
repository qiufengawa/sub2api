    ...
    admin: {
      ...
      paymentConfigDesc: 'Configure payment providers and settings',
	      ...
	      catalogImport: {
	        ...
	        securityNotice: 'Only catalog configuration is processed. Payment credentials, upstream tokens, users, API keys, orders, usage, and historical subscriptions are never imported. Downloaded templates reference this installation\'s real groups read-only and do not modify their rates, routes, or account bindings.',
