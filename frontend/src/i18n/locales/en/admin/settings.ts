export default {
    settings: {
      ...
      site: {
        ...
        siteLogo: 'Horizontal Logo',
        siteIcon: 'Browser Icon',
        uploadImage: 'Upload Image',
        uploadIcon: 'Upload Icon',
        remove: 'Remove',
        logoHint: 'Used in the top-left and key brand positions. Recommended: 320x80px, 4:1 horizontal PNG, WebP, or SVG. Max 500KB.',
        iconHint: 'Used only in browser tabs. Recommended: 64x64px or 128x128px, 1:1 PNG, ICO, or SVG. Max 300KB.',
        ...
        homeContentIframeWarning: ' iframe mode note: Some websites have X-Frame-Options or CSP security policies that prevent embedding in iframes. Embedded pages run in a sandbox without same-origin access, so pages that require same-origin storage may not work. If the page appears blank or shows an error, please verify the target website allows embedding, or consider using HTML mode to build your own content.',
