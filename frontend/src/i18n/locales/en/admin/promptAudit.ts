export default {
  promptAudit: {
    ...
    pool: {
      ...
      probeProgress: 'Config validated · request sent · awaiting service response…', probeResult: 'Config passed · request passed · HTTP {http} · {status} · {latency} ms',
    ...
    events: {
      ...
      startAt: 'Start time', endAt: 'End time', deleteSelected: 'Delete selected ({count})', deleteByFilter: 'Delete by filter', clearFilters: 'Clear filters',
      ...
      tableRegion: 'Prompt audit event list, horizontally scrollable', paginationSummary: 'Events', pageSize: 'Per page', previousPage: 'Previous page', nextPage: 'Next page',
