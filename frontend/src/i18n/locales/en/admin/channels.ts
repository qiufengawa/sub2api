export default {
    ...
    channelMonitor: {
      ...
      featureDisabledTitle: 'Channel monitor is disabled',
      featureDisabledDescription: 'Enable Channel Monitor in system settings before configuring probes or passive monitoring.',
      ...
      template: {
        ...
        loadError: 'Failed to load request templates',
    ...
    subscriptions: {
      ...
      resetEveryHours: 'Resets every {hours} hours',
