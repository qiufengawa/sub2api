export default {
  batchImage: {
    ...
    messages: {
      ...
      deleteOutputsConfirm: 'Delete generated image outputs while keeping this batch record and its billing history?',
      cancelled: 'Cancellation requested.',
      cancelFailed: 'Failed to cancel the job.',
      outputsDeleted: 'Generated outputs deleted.',
      deleteOutputsFailed: 'Failed to delete generated outputs.',
      batchDownloadStarted: 'Downloads for the selected jobs have started.',
      batchDownloadPartial: 'Downloaded {completed} job(s); {failed} failed and can be retried.',
      ...
      deletePartial: 'Deleted {deleted} job(s); {failed} failed and remain selected for retry.',
