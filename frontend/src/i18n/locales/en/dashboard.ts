export default {
  ...
  keys: {
    ...
    subscriptionIntent: {
      ...
      createDescription: 'The subscription group “{group}” is preselected. Review the key name and other settings before creating it.',
      bindTitle: 'Bind an existing key',
      bindDescription: 'Choose a key to bind to the “{group}” subscription group. Search, filters, and pagination remain available.',
      bindAction: 'Bind',
      alreadyBound: 'Bound',
      ...
      noKeysDescription: 'You do not have an API key yet. Create a new key with this subscription group already selected.',
      invalid: 'The subscription key request is invalid. Open it again from My Subscriptions.',
      unavailable: 'This subscription group has expired or is unavailable. Refresh My Subscriptions and try again.',
