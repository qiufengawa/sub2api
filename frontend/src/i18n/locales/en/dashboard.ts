export default {
  dashboard: {
    ...
    overview: {
      title: 'Account overview',
      status: { healthy: 'Service healthy', warning: 'Needs attention', danger: 'Service limited' },
      headerNoKey: 'No API key yet. Finish setup to start making requests.',
      headerReady: 'Your API key is ready. Send your first request now.',
      headerHealthy: 'Service is healthy. Last successful request was {time}.',
      headerDefault: 'Review your allowance, access health, and spending.',
      headerDataSummary: 'Review today and all-time usage, recent trends, model share, and requests.',
      headerAccountDisabled: 'This account is disabled. Contact an administrator or review the account status.',
      headerLowBalance: 'Your balance is empty and service may be affected.',
      headerQuotaNearLimit: 'A subscription or platform allowance is nearly exhausted.',
      rechargeOrRedeem: 'Top up or redeem',
      topUpOrSubscribe: 'Top up or subscribe',
      redeemBalance: 'Redeem balance',
      availableBalance: 'Available balance',
      subscriptionAllowance: 'Subscription allowance',
      subscriptionBilling: 'Subscription billing',
      todayDeduction: '{amount} charged today',
      frozenBalance: '{amount} frozen',
      activeSubscriptions: '{count} active subscriptions',
      expiresInDays: 'Expires in {days} days',
      todayUsage: 'Today usage',
      todaySection: 'Today',
      totalSection: 'All-time usage',
      updatedDaily: 'Live totals',
      allTime: 'Full history',
      totalUsageCost: 'Total cost',
      totalUsageRequests: 'Total requests',
      standardCost: '{amount} standard cost',
      balanceRemaining: '{amount} balance remaining',
      liveRequests: '{rpm} RPM · {tpm} TPM now',
      inputOutputTokens: '{input} input · {output} output',
      averageResponseTime: '{duration} average response',
      requestCount: '{count} requests',
      tokenCount: '{count} tokens',
      moreThanYesterday: '{percent}% more than yesterday',
      lessThanYesterday: '{percent}% less than yesterday',
      accessStatus: 'Access status',
      noApiKeyTitle: 'No API key yet',
      noApiKeyDescription: 'Create a key to start making requests.',
      keysAvailable: '{active} / {total} keys available',
      lastSuccess: 'Last success {time}',
      noSuccessfulCalls: 'No successful request yet',
      recentFailures: '{count} failures in 24h',
      usageTrend: 'Cost and request trend',
      periodSummary: '{cost} actual cost · {requests} requests',
      periodComparison: 'Vs previous period: cost {cost} · requests {requests}',
      newInPeriod: 'New',
      last7Days: 'Last 7 days',
      ...
      noTrendDescription: 'Cost and request trends will appear after your first API call.',
      viewApiKeys: 'View API keys',
      allowanceStatus: 'Allowance and subscriptions',
      allowanceStatusDescription: 'Most constrained allowance shown first',
      accountBalance: 'Account balance',
      manage: 'Manage',
      noAllowanceTitle: 'No allowance limits',
      noAllowanceDescription: 'Your account uses balance billing. Subscription and platform limits will appear here when configured.',
      daily: 'Daily',
      weekly: 'Weekly',
      monthly: 'Monthly',
      disabled: 'Disabled',
      ...
      costBreakdown: 'Model cost breakdown',
      costBreakdownDescription: 'Ranked by actual cost',
      modelShare: 'Model usage share',
      modelShareDescription: 'Recent model mix by token usage',
      modelRowMeta: '{requests} requests · {cost}',
      details: 'Details',
      otherModels: 'Other models',
      noCostTitle: 'No cost data yet',
      noCostDescription: 'Your top models will appear after you make requests.',
      recentActivity: 'Recent activity and errors',
      recentActivityDescription: 'Latest successful calls and failed requests',
      noActivityTitle: 'No request activity',
      noActivityDescription: 'Activity will appear after your first request.',
      successActivityMeta: '{cost} · {duration} response',
      requestFailed: 'Request failed',
      viewFailedRequests: 'View failed requests',
      gettingStartedTitle: 'Get started',
      gettingStartedDescription: 'Complete these three steps to use the API without being distracted by empty analytics.',
      firstRequestTitle: 'Send your first request',
      firstRequestDescription: 'Your key is ready. Copy the endpoint and example to verify your integration.',
      stepCreateKey: 'Create an API key',
      stepChooseChannel: 'View available models and channels',
      stepSendRequest: 'Send your first request',
      apiEndpoint: 'API endpoint',
      requestExample: 'Request example',
      copy: 'Copy',
      copied: 'Copied',
      copyRequest: 'Copy request',
      fullDocumentation: 'View full documentation',
      viewAvailableModels: 'View available models',
      completed: 'Completed',
      alertAccountDisabled: 'This account is disabled and cannot use the API.',
      alertNoActiveKey: 'No API key is currently available. Enable or create one.',
      alertLowBalance: 'Your balance is empty and there is no active subscription. Requests may stop.',
      alertQuota: 'An allowance is {percent}% used. Check the remaining quota.',
      alertFailures: '{count} requests failed in the last 24 hours. Review the error details.',
      alertExpiry: 'Your subscription expires within {days} days. Renew it to avoid interruption.',
      viewProfile: 'View account',
      manageKeys: 'Manage keys',
      viewSubscriptions: 'View subscriptions',
      viewUsage: 'View usage',
      loadFailedTitle: 'Could not load the account overview',
      loadFailedDescription: 'Account data is temporarily unavailable. Please try again.',
      retry: 'Retry'
    }
  },
  ...
  keys: {
    ...
    subscriptionIntent: {
      createKey: 'Create subscription key',
      createTitle: 'Create subscription key',
      createDescription: 'The routing group “{group}” covered by your plan is preselected. Review the key name and other settings before creating it.',
      bindTitle: 'Bind an existing key',
      bindDescription: 'Choose a key to bind to the plan-covered routing group “{group}”. Search, filters, and pagination remain available.',
      bindAction: 'Bind',
      alreadyBound: 'Bound',
      confirmTitle: 'Confirm key group change',
      confirmMessage: 'The key “{key}” will move from “{current}” to “{target}”. This changes its available models, routes, and billing source, and may affect requests currently using this key.',
      confirmAction: 'Confirm binding',
      bindSuccess: 'Key “{key}” is now bound to “{group}”',
      bindFailed: 'Could not bind the key. Confirm that the subscription is still active and try again.',
      noKeys: 'No keys available to bind',
      noKeysDescription: 'You do not have an API key yet. Create a new key with this plan-covered routing group already selected.',
      invalid: 'The subscription key request is invalid. Open it again from My Subscriptions.',
      unavailable: 'This plan-covered routing group is unavailable. Refresh My Subscriptions and try again.',
      groupsLoadFailed: 'Available groups could not be loaded, so the subscription key action cannot continue.',
    },
  ...
  usage: {
    ...
    cacheHitRateShort: 'Cache',
    cacheHitRateFormula: 'Cache read ÷ (uncached input + cache creation + cache read)',
    ...
    queryConditionsHint: 'Adjust the conditions, then query to refresh statistics, charts, and logs together.',
    queryAction: 'Query',
    appliedConditions: 'Current Scope',
    rankingOther: 'Other',
    ...
    tokens: 'Tokens',
    cost: 'Cost',
    billingSource: 'Funding Source',
    subscriptionPlan: 'Subscription Plan',
    billingPreference: 'Billing Preference',
    billingFallbackReason: 'Fallback Reason',
    billingSourceSubscription: 'Subscription',
    billingSourceWallet: 'Wallet',
    billingSourceLegacy: 'Legacy rule',
    billingPreferenceSubscriptionFirst: 'Subscription first',
    billingPreferenceWalletFirst: 'Wallet first',
    billingPreferenceSubscriptionOnly: 'Subscription only',
    billingPreferenceWalletOnly: 'Wallet only',
    billingFallbackWalletInsufficient: 'Wallet insufficient; used subscription',
    billingFallbackBothUnavailable: 'Subscription unavailable; charged wallet',
    billingFallbackSubscriptionExhausted: 'Subscription exhausted; charged wallet',
    billingFallbackSubscriptionUnavailable: 'No eligible subscription; charged wallet',
  ...
  availableChannels: {
    ...
    expandDetails: 'Expand channel details',
    collapseDetails: 'Collapse channel details',
  ...
  affiliate: {
    ...
    transfer: {
      ...
      confirmMessage: 'Transfer all available rebate quota ({amount}) to your account balance? This cannot be undone.',
  ...
  profile: {
    ...
    linkedProfileSourcesDescription: 'Some profile details may stay synced from third-party sign-in methods.',
	    ...
	    securityDescription: 'Manage your password, two-factor authentication, and passkeys together.',
	    billingPreference: {
	      title: 'Billing order',
	      description: 'Choose how requests are charged when both subscription credits and wallet balance are available. A single request is never split across sources.',
	      subscriptionFirst: 'Subscription credits first',
	      subscriptionFirstDesc: 'Use an eligible subscription first. When credits are exhausted, wallet fallback follows the plan setting.',
	      walletFirst: 'Wallet balance first',
	      walletFirstDesc: 'Use wallet balance when sufficient, then try eligible subscription credits if the wallet is insufficient.',
	      subscriptionOnly: 'Subscription credits only',
	      subscriptionOnlyDesc: 'Only subscription credits may be used. Requests are rejected when credits are insufficient.',
	      walletOnly: 'Wallet balance only',
	      walletOnlyDesc: 'Ignore subscription credits and charge every request to wallet balance.',
	    },
