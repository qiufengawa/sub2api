  ...
  payment: {
    ...
    admin: {
      ...
      offSale: '下架',
	      ...
	      groupId: '分组 ID',
	      primaryGroup: '主分组',
	      includedGroups: '包含的真实分组',
	      includedGroupsHint: '用户可将密钥绑定到这些分组；每次请求按所选分组自身的实际倍率计费。主分组用于兼容旧数据，始终包含。',
	      cycleQuota: '每周期积分',
      ...
      paymentConfigDesc: '管理支付服务商与相关设置',
	      ...
	      catalogImport: {
	        ...
	        issueCodes: {
	          ...
	          PLAN_GROUP_REQUIRED: '套餐必须通过 group_key 或 group_id 指定主分组',
	          PLAN_GROUP_REFERENCE_AMBIGUOUS: '套餐主分组不能同时填写 group_key 和 group_id',
	          PLAN_GROUP_ID_INVALID: '套餐主分组 ID 必须是正整数',
