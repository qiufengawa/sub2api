export default {
  batchImage: {
    ...
    messages: {
      ...
      deleteOutputsConfirm: '删除已生成的图片结果，但保留任务记录和账务历史？',
      cancelled: '已请求取消任务',
      cancelFailed: '取消失败',
      outputsDeleted: '已删除生成结果',
      deleteOutputsFailed: '删除生成结果失败',
      batchDownloadStarted: '已开始下载选中的任务',
      batchDownloadPartial: '已下载 {completed} 个任务；{failed} 个失败，可重试。',
      downloadFailed: '下载失败',
      ...
      deletePartial: '已删除 {deleted} 个任务；{failed} 个失败并保持选中，可重试。',
