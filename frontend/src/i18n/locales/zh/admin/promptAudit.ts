export default {
  promptAudit: {
    ...
    pool: {
      ...
      probeProgress: '配置校验通过 · 请求已发送 · 等待服务响应…', probeResult: '配置通过 · 请求通过 · HTTP {http} · {status} · {latency} ms',
    ...
    events: {
      ...
      startAt: '开始时间', endAt: '结束时间', deleteSelected: '删除选中项（{count}）', deleteByFilter: '按筛选删除', clearFilters: '清除筛选',
      ...
      tableRegion: 'Prompt 审计事件列表，可横向滚动', paginationSummary: '事件', pageSize: '每页', previousPage: '上一页', nextPage: '下一页',
