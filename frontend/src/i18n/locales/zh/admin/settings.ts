export default {
    settings: {
      ...
      site: {
        ...
        uploadIcon: '上传 Icon',
        remove: '移除',
        logoHint: '用于左上角和关键品牌位置。建议 320×80px、4:1 横版 PNG、WebP 或 SVG，最大 500KB。',
        iconHint: '仅用于浏览器标签页。建议 64×64px 或 128×128px、1:1 方形 PNG、ICO 或 SVG，最大 300KB。',
        ...
        homeContentIframeWarning:
          ' iframe 模式提示：部分网站设置了 X-Frame-Options 或 CSP 安全策略，禁止被嵌入到 iframe 中。嵌入页面运行在无同源访问权限的 sandbox 中，依赖同源存储的页面可能无法工作。如果页面显示空白或报错，请确认目标网站允许被嵌入，或考虑使用 HTML 模式自行构建页面内容。',
        compactHome: '简洁首页',
