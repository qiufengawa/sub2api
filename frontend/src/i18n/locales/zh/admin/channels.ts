export default {
    ...
    channels: {
      ...
      form: {
        ...
        webSearchEmulationHint: ' 开启后该渠道下所有 Anthropic 分组的账号将自动拦截 web_search 请求，请谨慎操作',
        ...
        bedrockCCCompatHint: ' 开启后，该渠道下 Bedrock 账号的请求将进行 Claude Code 兼容处理（thinking 类型转换、tool_use ID 清理）',
        basicSettings: '基础设置',
        addPlatform: '添加平台',
    ...
    channelMonitor: {
      ...
      loadError: '加载监控列表失败',
      featureDisabledTitle: '渠道监控未启用',
      featureDisabledDescription: '请先在系统设置中启用渠道监控，再配置主动探测或数据监控。',
