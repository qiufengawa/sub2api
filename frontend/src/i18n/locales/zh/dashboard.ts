export default {
  ...
  keys: {
    ...
    subscriptionIntent: {
      createKey: '创建订阅密钥',
      createTitle: '创建订阅密钥',
      createDescription: '已为你预选订阅分组“{group}”。请确认密钥名称和其他设置后创建。',
      bindTitle: '绑定现有密钥',
      bindDescription: '请选择一把密钥绑定到订阅分组“{group}”。你可以继续使用搜索、筛选和分页查找。',
      bindAction: '绑定',
      alreadyBound: '已绑定',
      ...
      noKeys: '暂无可绑定的密钥',
      noKeysDescription: '你还没有 API 密钥，可以直接创建一把已预选该订阅分组的新密钥。',
      invalid: '订阅密钥操作参数无效，请从“我的订阅”重新进入',
      unavailable: '该订阅分组已失效或当前不可用，请刷新“我的订阅”后重试',
