      ...
      <template #table>
        ...
        >
          ...
          <template #cell-actions="{ row }">
            <div class="flex items-center gap-1">
              <button type="button" @click="handleEdit(row)" class="btn btn-ghost btn-icon text-gray-500 hover:text-primary-600 dark:hover:text-primary-400" :title="t('common.edit')" :aria-label="t('common.edit')">
                <Icon name="edit" size="sm" />
              </button>
              <button type="button" @click="handleDelete(row)" class="btn btn-ghost btn-icon text-gray-500 hover:bg-red-50 hover:text-red-600 dark:hover:bg-red-900/20 dark:hover:text-red-400" :title="t('common.delete')" :aria-label="t('common.delete')">
                <Icon name="trash" size="sm" />
              </button>
              <button type="button" @click="openMenu(row, $event)" class="btn btn-ghost btn-icon text-gray-500 hover:text-gray-900 dark:hover:text-white" :title="t('common.more')" :aria-label="t('common.more')">
