...
<style scoped>
.ops-dashboard-shell--fullscreen{min-height:100dvh;background:var(--ui-surface-muted)}.ops-dashboard{display:grid;min-width:0;gap:8px;padding-bottom:40px}.ops-dashboard__traffic-grid{display:grid;min-width:0;grid-template-columns:minmax(0,1fr);gap:16px}.ops-dashboard__traffic-trends{display:grid;min-width:0;grid-template-rows:minmax(340px,1fr) 190px;gap:16px}.ops-dashboard__throughput{min-width:0;min-height:340px}.ops-dashboard__switch-rate{min-width:0;height:190px}.ops-dashboard__concurrency{min-height:420px}.ops-dashboard__quality-grid{display:grid;min-width:0;grid-template-columns:minmax(0,1fr);gap:16px}.ops-dashboard__error-trend{min-width:0;min-height:360px}.ops-dashboard__quality-side{display:grid;min-width:0;grid-template-columns:repeat(2,minmax(0,1fr));gap:16px}.ops-dashboard__quality-panel{min-width:0;min-height:220px}@media(max-width:767px){.ops-dashboard__quality-side{grid-template-columns:minmax(0,1fr)}.ops-dashboard__traffic-trends{grid-template-rows:minmax(280px,1fr) 180px}.ops-dashboard__throughput{min-height:280px}.ops-dashboard__concurrency{min-height:360px}}
</style>
