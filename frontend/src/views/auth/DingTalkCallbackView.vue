<template>
  <AuthFormPanel
      :title="t('auth.dingtalk.callbackTitle')"
      :subtitle="isProcessing ? t('auth.dingtalk.callbackProcessing') : t('auth.dingtalk.callbackHint')"
    >

      <transition name="fade">
        <div v-if="isProcessing" class="oauth-callback__processing" aria-live="polite">
          <UiSpinner size="lg" :label="t('auth.dingtalk.callbackProcessing')" />
        </div>
        ...
        >
          ...
          <template v-else-if="needsBindLogin">
            ...
            <div class="oauth-callback-stack">
              <AuthTextField
                id="dingtalk-bind-login-email"
                v-model="bindLoginEmail"
                test-id="dingtalk-bind-login-email"
                icon="mail"
                type="email"
              ...
              />
              <AuthTextField
                id="dingtalk-bind-login-password"
                v-model="bindLoginPassword"
                test-id="dingtalk-bind-login-password"
                icon="lock"
                type="password"
                revealable
          ...
          <template v-else-if="needsTotpChallenge">
            ...
            <div class="oauth-callback-stack">
              <AuthTextField
                id="dingtalk-bind-login-totp"
                v-model="totpCode"
                test-id="dingtalk-bind-login-totp"
                icon="key"
                type="text"
                inputmode="numeric"
                :maxlength="6"
