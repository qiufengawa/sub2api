      ...
      <transition name="fade">
        ...
        >
            ...
            >
              <div class="oauth-callback-stack">
                ...
                <AuthTextField
                  ...
                  test-id="existing-account-email"
                  icon="mail"
                  type="email"
          ...
          <template v-else-if="needsBindLogin">
            ...
            <div v-else class="oauth-callback-stack">
              <AuthTextField
                id="wechat-bind-login-email"
                v-model="bindLoginEmail"
                test-id="wechat-bind-login-email"
                icon="mail"
                type="email"
                :label="t('auth.emailLabel')"
                :placeholder="t('auth.emailPlaceholder')"
              ...
              <AuthTextField
                ...
                test-id="wechat-bind-login-password"
                icon="lock"
                type="password"
                revealable
          ...
          <template v-else-if="needsTotpChallenge">
            ...
            <div class="oauth-callback-stack">
              <AuthTextField
                ...
                v-model="totpCode"
                test-id="wechat-bind-login-totp"
                icon="key"
                type="text"
                inputmode="numeric"
                :maxlength="6"
