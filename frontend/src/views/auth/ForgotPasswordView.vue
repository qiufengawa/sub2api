<template>
  <AuthFormPanel :title="t('auth.forgotPasswordTitle')" :subtitle="t('auth.forgotPasswordHint')">

      <!-- Success State -->
      <div v-if="isSubmitted" class="auth-state-stack">
        <UiAlert tone="success" :title="t('auth.resetEmailSent')" :message="t('auth.resetEmailSentHint')" />
        <UiButton to="/login" density="compact" block>
      ...
      <form v-else class="auth-form" @submit.prevent="handleSubmit">
        ...
        <UiButton
          ...
          block
        >
          <template v-if="!isLoading" #icon><Icon name="mail" size="sm" /></template>
