<template>
  <AuthFormPanel
      ...
      :subtitle="isProcessing ? t('auth.linuxdo.callbackProcessing') : t('auth.linuxdo.callbackHint')"
    >

      <transition name="fade">
        <div v-if="isProcessing" class="oauth-callback__processing" aria-live="polite">
          <UiSpinner size="lg" :label="t('auth.linuxdo.callbackProcessing')" />
        </div>
          ...
          <template v-else-if="needsBindLogin">
            ...
            <div class="oauth-callback-stack">
              <AuthTextField
                ...
                test-id="linuxdo-bind-login-email"
                icon="mail"
                type="email"
              ...
              <AuthTextField
                ...
                test-id="linuxdo-bind-login-password"
                icon="lock"
                type="password"
                revealable
          ...
          <template v-else-if="needsTotpChallenge">
            ...
            <div class="oauth-callback-stack">
              <AuthTextField
                ...
                v-model="totpCode"
                test-id="linuxdo-bind-login-totp"
                icon="key"
                type="text"
                inputmode="numeric"
                :maxlength="6"
