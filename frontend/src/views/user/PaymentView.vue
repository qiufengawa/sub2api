          ...
          <template v-if="activeTab === 'recharge'">
            <div class="grid gap-3 lg:grid-cols-[minmax(0,1.15fr)_minmax(320px,0.85fr)]">
              <section class="overflow-hidden rounded border border-gray-200 bg-white dark:border-dark-700 dark:bg-dark-800">
                ...
                <div v-if="enabledMethods.length === 0" class="py-12 text-center">
              ...
              <div v-if="enabledMethods.length >= 1" class="space-y-3 lg:sticky lg:top-4 lg:self-start">
                <div class="card p-4" data-testid="recharge-order-summary">
            ...
            <template v-else>
              <div v-if="activeSubscriptions.length > 0" class="mb-3">
                ...
                <div class="divide-y divide-gray-100 overflow-hidden rounded border border-gray-200 bg-white dark:divide-dark-700 dark:border-dark-700 dark:bg-dark-800">
                  ...
                  >
                    <div :class="['mt-0.5 h-8 w-1 shrink-0 rounded-[2px]', platformAccentBarClass(sub.group?.platform || '')]" />
                    <div class="min-w-0 flex-1">
                      <div class="flex items-center gap-1.5">
                        ...
                        <span :class="['inline-flex shrink-0 items-center gap-1 rounded-[3px] px-1.5 py-0.5 text-[9px] font-medium', platformBadgeLightClass(sub.group?.platform || '')]">
                          <PlatformIcon :platform="sub.group?.platform" size="xs" />
                          {{ platformLabel(sub.group?.platform || '') }}
                        </span>
                      </div>
                      <div class="mt-1 flex flex-wrap gap-x-3 gap-y-0.5 text-[11px] text-gray-500 dark:text-gray-400">
