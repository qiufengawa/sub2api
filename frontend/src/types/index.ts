...
export interface User {
  ...
  auth_bindings?: Partial<
    Record<UserAuthProvider, boolean | UserAuthBindingStatus>
  >;
...
export interface Account {
  ...
  extra?: CodexUsageSnapshot &
    OpenAICompactState & {
      ...
      antigravity_credits_overages?: Record<
        string,
        { activated_at: string; active_until: string }
      >;
  ...
  scheduler_score?: {
    ...
    priority_tier_active?: boolean;
    metrics_mode?: "static_snapshot" | string;
  } | null;
...
export interface AdminDataPayload {
  type?: string;
  version?: number;
  priority_semantics?: "higher_wins" | "lower_wins";
  priority_pivot?: number;
  exported_at: string;
...
export interface AdminDataImportResult {
  ...
  legacy_priority_migrated?: boolean;
...
export type UsageRequestType =
  "unknown" | "sync" | "stream" | "ws_v2" | "cyber" | "live";
