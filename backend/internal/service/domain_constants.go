...
// Group type compatibility constants. New runtime groups are always standard;
// the legacy value is accepted only by catalog migration code.
const (
...
const (
	...
	// Geetest 验证码设置
	SettingKeyGeetestCaptchaEnabled = "geetest_captcha_enabled"
	...
	SettingKeySiteLogo                    = "site_logo"                     // 横版网站 Logo (base64)
	SettingKeySiteIcon                    = "site_icon"                     // 浏览器标签页 Icon (base64)
