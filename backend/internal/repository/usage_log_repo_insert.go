...
var usageLogInsertArgTypes = [...]string{
	...
	"text",        // billing_source
	"text",        // billing_preference
	"text",        // billing_fallback_reason
}
...
func prepareUsageLogInsert(log *service.UsageLog) usageLogInsertPrepared {
	...
	return usageLogInsertPrepared{
		...
		args: []any{
			...
			createdAt,
			defaultUsageBillingSource(log.BillingSource),
			nullString(log.BillingPreference),
			nullString(log.BillingFallbackReason),
		},
	}
}

func defaultUsageBillingSource(value string) string {
	value = strings.TrimSpace(value)
	if value == "" {
		return service.BillingSourceLegacy
	}
	return value
}
