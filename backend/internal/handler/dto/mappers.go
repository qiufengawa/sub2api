...
func userSubscriptionFromServiceBase(sub *service.UserSubscription) UserSubscription {
	...
	return UserSubscription{
		...
		FiveHourQuotaUSD:      sub.FiveHourQuotaUSD,
		FiveHourUsageUSD:      sub.FiveHourUsageUSD,
		FiveHourReservedUSD:   sub.FiveHourReservedUSD,
		FiveHourStartedAt:     sub.FiveHourStartedAt,
		CycleQuotaUSD:         sub.CycleQuotaUSD,
		CycleUsageUSD:         sub.CycleUsageUSD,
		CycleReservedUSD:      sub.CycleReservedUSD,
		TotalQuotaUSD:         sub.TotalQuotaUSD,
		TotalUsageUSD:         sub.TotalUsageUSD,
		TotalReservedUSD:      sub.TotalReservedUSD,
