...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	settingService := service.ProvideSettingService(settingRepository, client, proxyRepository, configConfig)
	...
	schedulerSnapshotService, err := service.ProvideSchedulerSnapshotService(schedulerCache, schedulerOutboxRepository, accountRepository, groupRepository, configConfig)
	if err != nil {
		return nil, err
	}
	...
	paymentConfigService := service.ProvidePaymentConfigService(client, settingRepository, encryptionKey, apiKeyAuthCacheInvalidator, billingCacheService)
	...
	playgroundHandler := handler.NewPlaygroundHandler(apiKeyService)
	...
	usageBillingReservationCleanupService := service.ProvideUsageBillingReservationCleanupService(usageBillingRepository, configConfig)
