...
type User struct {
	...
	// RevocationVersion holds the value of the "revocation_version" field.
	RevocationVersion int64 `json:"revocation_version,omitempty"`
...
func (*User) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case user.FieldID, user.FieldConcurrency, user.FieldRevocationVersion, user.FieldRpmLimit:
			values[i] = new(sql.NullInt64)
		case user.FieldEmail, user.FieldPasswordHash, user.FieldRole, user.FieldStatus, user.FieldBillingPreference, user.FieldUsername, user.FieldNotes, user.FieldTotpSecretEncrypted, user.FieldSignupSource, user.FieldBalanceNotifyThresholdType, user.FieldBalanceNotifyExtraEmails:
...
func (_m *User) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case user.FieldRevocationVersion:
			if value, ok := values[i].(*sql.NullInt64); !ok {
				return fmt.Errorf("unexpected type %T for field revocation_version", values[i])
			} else if value.Valid {
				_m.RevocationVersion = value.Int64
			}
...
func (_m *User) String() string {
	...
	builder.WriteString(", ")
	builder.WriteString("revocation_version=")
	builder.WriteString(fmt.Sprintf("%v", _m.RevocationVersion))
	builder.WriteString(", ")
	builder.WriteString("status=")
	builder.WriteString(_m.Status)
	builder.WriteString(", ")
	builder.WriteString("billing_preference=")
	builder.WriteString(_m.BillingPreference)
	builder.WriteString(", ")
